...
class CafeForm(FlaskForm):
    ...
    close = StringField('Opening Time e.g. 5PM', validators=[DataRequired()])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        with open('./coffee_review_website/cafe-data.csv', 'a', newline='', encoding='utf-8') as csv_file:
...
@app.route('/cafes')
def cafes():
    with open('./coffee_review_website/cafe-data.csv', newline='', encoding='utf-8') as csv_file:
